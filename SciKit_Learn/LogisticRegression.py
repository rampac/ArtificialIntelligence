...
vAR_df = vAR_pd.read_excel('C:/Ramesh/AI/1_AI Boot Camp Problem1 - Intercompany_Transaction_Train.xlsx')
...
vAR_df3 = vAR_pd.read_excel('C:/Ramesh/AI/1_AI Boot Camp Problem1 - Intercompany_Transaction_Test.xlsx')
...
vAR_df6 = vAR_pd.read_excel('C:/Ramesh/AI/1_AI Boot Camp Problem1 - Intercompany_Transaction_Test.xlsx')
vAR_df7 = vAR_df6.merge(vAR_Labels_Pred,left_index=True, right_index=True)
vAR_df8 = vAR_df7.to_excel('C:/Ramesh/AI/Problem1_Predicted_Results.xlsx')

vAR_df9 = vAR_pd.read_excel('C:/Ramesh/AI/Problem1_Predicted_Results.xlsx')
print(vAR_df9)